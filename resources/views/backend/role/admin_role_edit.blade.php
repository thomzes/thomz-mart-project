                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <fieldset>
                                        <input type="checkbox" id="checkbox_8" name="setting" value="1" {{ $adminuser->setting == 1 ? 'checked' : '' }}>
                                        <label for="checkbox_8">Setting</label>
                                    </fieldset>

                                    <fieldset>
                                        <input type="checkbox" id="checkbox_9" name="return_order" value="1" {{ $adminuser->return_order == 1 ? 'checked' : '' }}>
                                    ...
                                    <fieldset>
                                        <input type="checkbox" id="checkbox_11" name="orders" value="1" {{ $adminuser->orders == 1 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="controls">
                                    <fieldset>
                                        <input type="checkbox" id="checkbox_12" name="stock" value="1" {{ $adminuser->stock == 1 ? 'checked' : '' }}>
                                        <label for="checkbox_12">Stock</label>
                                    </fieldset>

                                    <fieldset>
                                        <input type="checkbox" id="checkbox_13" name="reports" value="1" {{ $adminuser->reports == 1 ? 'checked' : '' }}>
                                        <label for="checkbox_13">Reports</label>
                                    </fieldset>

                                    <fieldset>
                                        <input type="checkbox" id="checkbox_14" name="alluser" value="1" {{ $adminuser->alluser == 1 ? 'checked' : '' }}>
                                        <label for="checkbox_14">All User</label>
                                    </fieldset>

                                    <fieldset>
                                        <input type="checkbox" id="checkbox_15" name="admin_user_role" value="1" {{ $adminuser->admin_user_role == 1 ? 'checked' : '' }}>
