  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Thomz Mart</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Thomz Mart Head Office
               Email:support@thomzmart.com <br>
               Mob: 1245454545 <br>
...
<h3>Products</h3>
  ...
  <table width="100%">
    ...
    @foreach($orderItem as $item)
      <tr class="font">
        <td align="center">
            <img src="{{ public_path($item->product->product_thumbnail) }}" style="height: 60px;" width="60px;" alt="">
        </td>
