                       ...
                       <div class="col-12">
                           <div class="row">
                            ...
                            <div class="row">
                                ...
                                {{-- end col md 6 --}}
                                <div class="col-md-6">
                                    <img class="rounded-circle" id="showImage" src="{{ (!empty($editData->profile_photo_path)) ? url('upload/admin_images/'.$editData->profile_photo_path) : url('upload/no_image.jpg') }}" alt="{{ $editData->name }}" style="width: 100px; height:100px;">
                                </div>
                                {{-- end col md 6 --}}
                            </div>
                            {{-- end row --}}
