									...
									<div class="product-tab">
										...
										<div class="product-add-review">
											...
											<div class="review-form">
												...
												@guest
													<p><b>Want to Review The Product? You Need to Login First <a href="{{ route('login') }}">Login Here</a></b></p>
...
<!-- ============================================== UPSELL PRODUCTS : END ============================================== -->
	...
	<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-62456ae8153c9117"></script>
